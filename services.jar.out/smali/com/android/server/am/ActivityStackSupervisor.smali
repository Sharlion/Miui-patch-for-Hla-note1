...
# instance fields
.field private mBackFloatingStacks:Ljava/util/ArrayList;
...
.field private mFrontFloatingStacks:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput-object v1, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBackFloatingStacks:Ljava/util/ArrayList;
...
.method final activityIdleInternalLocked(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    const-string v5, "ACT-Activity idle: "
...
.method adjustStackFocus(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;
    ...
    iget-boolean v5, v5, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    iget-boolean v5, v0, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    invoke-virtual {v5, v7, v8, v9, v6}, Lcom/android/server/am/ActivityManagerService;->createStack(IIIF)I
    ...
    const-string v7, "adjustStackFocus: New stack (from a floating stack) r="
...
.method closeStackLocked(Lcom/android/server/am/ActivityStack;)V
    .locals 6
    .parameter "stack"
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/server/am/ActivityManagerService;->removeTask(II)Z
...
.method createFloatingStack()I
    .locals 5

    .prologue
    .line 3414
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStackSupervisor;->createStack()I
    ...
    const-string v4, "createFloatingStack: new floating stack id = "
    ...
    iput-boolean v2, v0, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z

    .line 3418
    iget-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
...
.method ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;I)V
    ...
    const-string v4, "ensureActivitiesVisibleLocked: consider front"
    ...
    const-string v4, "ensureActivitiesVisibleLocked: consider back"
...
.method getAppStackLocked()Lcom/android/server/am/ActivityStack;
    ...
    iget-boolean v3, v2, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
...
.method public getBackFloatStacks()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 3713
    iget-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBackFloatingStacks:Ljava/util/ArrayList;
...
.method getFocusedStack()Lcom/android/server/am/ActivityStack;
    ...
    .line 281
    :pswitch_1
    iget-object v1, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
    ...
    iget-boolean v1, v1, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    const-string v3, "getFocusedStack: mFocusedStack="
    ...
    const-string v3, " is not floating, return top floating"
...
.method public getFrontFloatStacks()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 3709
    iget-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
...
.method keepStickyStackLocked()V
    ...
    .line 3642
    .local v4, stickyStacks:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityStack;>;"
    iget-object v7, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
    ...
    .line 3644
    .local v0, floatingStack:Lcom/android/server/am/ActivityStack;
    iget-boolean v7, v0, Lcom/android/server/am/ActivityStack;->mStickyStack:Z
    ...
    const-string v9, "keepStickyStackLocked: stack = "
    ...
    .line 3651
    .end local v0           #floatingStack:Lcom/android/server/am/ActivityStack;
    :cond_3
    const/4 v1, 0x0
    ...
    .line 3653
    .local v3, stickyStack:Lcom/android/server/am/ActivityStack;
    iget-object v7, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
...
.method moveActivityTaskToFloatingStackLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    const-string v6, " moveActivityTaskToFloatingStackLocked return directly, targetActivity is "
    ...
    invoke-virtual {v4, v5, v8, v6, v7}, Lcom/android/server/am/ActivityManagerService;->createStack(IIIF)I
    ...
    const-string v6, "moveActivityTaskToFloatingStackLocked: New floating stack stackId="
    ...
    invoke-virtual {v0, v8}, Lcom/android/server/am/ActivityRecord;->updateFullscreen(Z)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/wm/WindowManagerService;->miniMaxAppWindow(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1, v4, v9}, Lcom/android/server/am/ActivityStack;->addTask(Lcom/android/server/am/TaskRecord;Z)V
    ...
    invoke-virtual {v4, v5, v6, v9}, Lcom/android/server/wm/WindowManagerService;->addTask(IIZ)V
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/am/ActivityManagerService;->setFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;)V

    .line 3624
    invoke-virtual {p0, p1}, Lcom/android/server/am/ActivityStackSupervisor;->adjustStackFocus(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;

    .line 3625
    invoke-virtual {p0, v8}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStack(Z)V

    .line 3627
    iget-object v4, p1, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;

    iput-boolean v9, v4, Lcom/android/server/am/ProcessRecord;->inMaxOrRestore:Z
...
.method moveFloatingStackToAppStackLocked(Lcom/android/server/am/ActivityStack;Z)Lcom/android/server/am/ActivityStack;
    .locals 14
    .parameter "floatingStack"
    .parameter "doResumeTop"

    .prologue
    .line 3534
    iget-object v5, p1, Lcom/android/server/am/ActivityStack;->mResumedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    .line 3540
    .local v8, tmp:Lcom/android/server/am/ActivityStack;
    iget-boolean v9, v8, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    .line 3547
    .end local v8           #tmp:Lcom/android/server/am/ActivityStack;
    :cond_0
    if-nez v1, :cond_3
    ...
    invoke-virtual {v9, v10, v11, v12, v13}, Lcom/android/server/am/ActivityManagerService;->createStack(IIIF)I

    move-result v4

    .line 3551
    .local v4, stackId:I
    sget-boolean v9, Lcom/android/server/am/ActivityManagerService;->DEBUG_FOCUS:Z

    if-nez v9, :cond_1

    sget-boolean v9, Lcom/android/server/am/ActivityManagerService;->DEBUG_STACK:Z
    ...
    const-string v11, "moveFloatingStackToAppStackLocked: New stack stackId="
    ...
    invoke-virtual {v0, v9}, Lcom/android/server/am/ActivityRecord;->updateFullscreen(Z)V
    ...
    invoke-virtual {v9, v10}, Lcom/android/server/wm/WindowManagerService;->miniMaxAppWindow(Landroid/os/IBinder;)V
    ...
    .restart local v8       #tmp:Lcom/android/server/am/ActivityStack;
    :cond_4
    add-int/lit8 v2, v2, 0x1
    ...
    :cond_5
    invoke-virtual {p0, v6}, Lcom/android/server/am/ActivityStackSupervisor;->removeTask(Lcom/android/server/am/TaskRecord;)V

    .line 3567
    const/4 v9, 0x1

    invoke-virtual {v1, v6, v9}, Lcom/android/server/am/ActivityStack;->addTask(Lcom/android/server/am/TaskRecord;Z)V
    ...
    const-string v11, "ACT-remove floating stack = "
    ...
    .line 3575
    iget-object v9, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;

    invoke-virtual {v9, p1}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    .line 3576
    iget-object v9, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBackFloatingStacks:Ljava/util/ArrayList;
    ...
    invoke-virtual {v9, v5}, Lcom/android/server/am/ActivityManagerService;->setFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;)V

    .line 3581
    invoke-virtual {p0, v5}, Lcom/android/server/am/ActivityStackSupervisor;->adjustStackFocus(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;

    .line 3582
    const/4 v9, 0x0

    invoke-virtual {p0, v9}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStack(Z)V
    ...
    iput-boolean v10, v9, Lcom/android/server/am/ProcessRecord;->inMaxOrRestore:Z

    .line 3586
    iget-object v9, p0, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v9, v9, Lcom/android/server/am/ActivityManagerService;->mMwActivityMonitor:Lcom/android/server/am/MwActivityMonitor;

    iget-object v10, v5, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;

    invoke-virtual {v9, v5, v10}, Lcom/android/server/am/MwActivityMonitor;->resetProcessMiniMaxStatus(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {p0, v1, v9, v10}, Lcom/android/server/am/ActivityStackSupervisor;->resumeTargetTopActivitiesLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
...
.method moveFloatingStackToBackLocked(Lcom/android/server/am/ActivityStack;)V
    ...
    .prologue
    .line 3496
    iget-boolean v4, p1, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    const-string v6, "moveFloatingStackToBackLocked: stack = "
    ...
    .line 3503
    iget-object v4, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;

    invoke-virtual {v4, p1}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    .line 3504
    iget-object v4, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBackFloatingStacks:Ljava/util/ArrayList;
    ...
    .line 3510
    .local v3, topFloating:Lcom/android/server/am/ActivityStack;
    if-eqz v3, :cond_0
    ...
    .line 3514
    .end local v3           #topFloating:Lcom/android/server/am/ActivityStack;
    :cond_2
    const/4 v1, 0x0
    ...
    .line 3516
    .local v2, tmp:Lcom/android/server/am/ActivityStack;
    iget-boolean v4, v2, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
...
.method moveFloatingStackToFrontLocked(Lcom/android/server/am/ActivityStack;)V
    ...
    .prologue
    .line 3426
    iget-boolean v2, p1, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    .line 3433
    .local v1, tmp:Lcom/android/server/am/ActivityStack;
    if-ne v1, p1, :cond_2
    ...
    const-string v4, "moveFloatingStackToFrontLocked: stack = "
    ...
    .line 3443
    .end local v0           #i:I
    .end local v1           #tmp:Lcom/android/server/am/ActivityStack;
    :cond_3
    iget-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBackFloatingStacks:Ljava/util/ArrayList;
    ...
    const-string v4, " from mBackFloatingStacks"
...
.method moveHomeStack(Z)V
    ...
    const-string v7, "ACT-moveHomeTask toFront : "
    ...
    const-string v7, "moveHomeTask: mStackState old="

    invoke-virtual {v3, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v7, p0, Lcom/android/server/am/ActivityStackSupervisor;->mStackState:I
    ...
    .line 391
    iget-object v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
    ...
    .line 393
    .local v2, tmp:Lcom/android/server/am/ActivityStack;
    iget-boolean v3, v2, Lcom/android/server/am/ActivityStack;->mStickyStack:Z
    ...
    .line 395
    iget-object v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBackFloatingStacks:Ljava/util/ArrayList;
...
.method moveNextFloatingStackToTopLocked(Lcom/android/server/am/ActivityStack;)Z
    .locals 11
    .parameter "curTop"
    ...
    .line 3455
    .local v4, next:Lcom/android/server/am/ActivityStack;
    iget-object v7, p0, Lcom/android/server/am/ActivityStackSupervisor;->mFrontFloatingStacks:Ljava/util/ArrayList;
    ...
    .end local v4           #next:Lcom/android/server/am/ActivityStack;
    check-cast v4, Lcom/android/server/am/ActivityStack;

    .line 3458
    .restart local v4       #next:Lcom/android/server/am/ActivityStack;
    if-eqz p1, :cond_0
    ...
    const-string v9, "ACT-moveNextFloatingStackToTopLocked next = "
    ...
    const-string v9, " mStackState = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/server/am/ActivityStackSupervisor;->mStackState:I

    invoke-static {v9}, Lcom/android/server/am/ActivityStackSupervisor;->stackStateToString(I)Ljava/lang/String;
    ...
    .line 3469
    invoke-virtual {p0, v4}, Lcom/android/server/am/ActivityStackSupervisor;->moveFloatingStackToFrontLocked(Lcom/android/server/am/ActivityStack;)V
    ...
    const-string v9, "moveNextFloatingStackToTopLocked: mStackState old="
    ...
    invoke-static {v10}, Lcom/android/server/am/ActivityStackSupervisor;->stackStateToString(I)Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcom/android/server/am/ActivityStack;->moveHomeTaskToTop()V
...
.method removeTask(Lcom/android/server/am/TaskRecord;)V
    ...
    .line 470
    iget-object v7, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBackFloatingStacks:Ljava/util/ArrayList;
    ...
    .line 479
    iget-boolean v6, v4, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    .line 483
    .local v0, appStack:Lcom/android/server/am/ActivityStack;
    iget-boolean v6, v0, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    const-string v8, "ACT-BMW, removeTask: update focus stack "
    ...
    const-string v8, " when the last floating stack removed"
...
.method resumeTargetTopActivitiesLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    .line 3674
    .local v0, isFront:Z
    iget-boolean v5, p1, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    iget-boolean v5, v5, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z

    if-eqz v5, :cond_2

    iget-boolean v5, v2, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    .line 3677
    invoke-virtual {p0, v6}, Lcom/android/server/am/ActivityStackSupervisor;->moveNextFloatingStackToTopLocked(Lcom/android/server/am/ActivityStack;)Z
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    .line 1823
    :cond_d
    iget-boolean v4, v3, Lcom/android/server/am/ActivityStack;->mFloatingStack:Z
    ...
    invoke-virtual {v4, v6}, Lcom/android/server/am/MwActivityMonitor;->matchDisableFloatActivityList(Ljava/lang/String;)Z
    ...
    const-string v8, ", task.realActivity = "

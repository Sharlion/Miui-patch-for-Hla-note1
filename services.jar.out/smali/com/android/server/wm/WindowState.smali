...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    iput-boolean v9, p0, Lcom/android/server/wm/WindowState;->inMiniMax:Z
...
.method public adjustFloatingRect(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/wm/StackBox;->adjustFloatingRect(II)V
...
.method public getFloatingRect(III)Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/wm/StackBox;->getBoxBounds(III)Landroid/graphics/Rect;
...
.method getStackOffsets([I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/StackBox;->getBoxOffsets([I)V
...
.method public isFocusStackBox()Z
    .locals 12
    ...
    const-string v8, "WindowState"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "isFocusStackBox stack = "
...
.method public isStickStack()Z
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/StackBox;->mIsSticky:Z
...
.method public miniMax()Z
    ...
    .line 1587
    iput-boolean v3, p0, Lcom/android/server/wm/WindowState;->inMiniMax:Z
    ...
    const-string v2, "miniMaxLw = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/server/wm/WindowState;->inMiniMax:Z
    ...
    .line 1591
    invoke-virtual {p0, v3, v3}, Lcom/android/server/wm/WindowState;->hideLw(ZZ)Z

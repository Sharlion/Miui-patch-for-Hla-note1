...
.method public enter()V
    ...
    invoke-static {}, Landroid/net/wifi/p2p/WifiP2pService;->access$10804()I

    move-result v4

    invoke-virtual {v2, v3, v4, v6}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->obtainMessage(III)Landroid/os/Message;
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendP2pTxBroadcast(Z)V
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$4200(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/util/HashMap;
    ...
    const-string v3, "mClientIp clear"
    ...
    const-string/jumbo v2, "send connecting toast"
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    .line 2026
    :sswitch_0
    invoke-static {}, Landroid/net/wifi/p2p/WifiP2pService;->access$10800()I
    ...
    invoke-static {v4, v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$10200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;I)V
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$11100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pDeviceList;
    ...
    invoke-static {v4, p1, v5, v6}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$1400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;II)V
    ...
    invoke-static {v4, p1, v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;I)V
    ...
    invoke-static {v4, v7}, Landroid/net/wifi/p2p/WifiP2pService;->access$11302(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v4, v7}, Landroid/net/wifi/p2p/WifiP2pService;->access$2602(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v4, v7}, Landroid/net/wifi/p2p/WifiP2pService;->access$11502(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->deferMessage(Landroid/os/Message;)V
    invoke-static {v4, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$11600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$5700(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$1500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pDeviceList;
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$4700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->deferMessage(Landroid/os/Message;)V
    invoke-static {v4, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$11700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V

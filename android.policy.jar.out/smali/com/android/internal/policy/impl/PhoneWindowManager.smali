...
.method static synthetic access$1100(Lcom/android/internal/policy/impl/PhoneWindowManager;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$200(Lcom/android/internal/policy/impl/PhoneWindowManager;)Lcom/mediatek/common/hdmi/IHDMINative;
    .locals 1
    .parameter "x0"

    .prologue
    .line 146
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHDMI:Lcom/mediatek/common/hdmi/IHDMINative;
...
.method private isGestureKeyCode(I)Z
    .locals 2
    .parameter "keyCode"
...
.method private isGesturePowerOn()Z
    .locals 11
    ...
    const-string v10, "isGesturePowerOn bInput="
...
.method public applyPostLayoutPolicyLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    const-string v8, "Setting mDismissKeyguard to true by win "
    ...
    .line 3856
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSecureDismissingKeyguard:Z
...
.method dispatchMediaKeyWithWakeLockToAudioService(Landroid/view/KeyEvent;)V
    ...
    const-string v4, "dispatchMediaKeyWithWakeLockToAudioService: "
...
.method public finishPostLayoutPolicyLw()I
    ...
    const-string v8, " isKeyguardSecure()= "
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    .line 1042
    .local v4, ipoEventFilter:Landroid/content/IntentFilter;
    ...
    new-instance v9, Lcom/android/internal/policy/impl/PhoneWindowManager$6;

    invoke-direct {v9, p0}, Lcom/android/internal/policy/impl/PhoneWindowManager$6;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;)V
    ...
    .line 1171
    :try_start_1
    iget-object v8, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHDMI:Lcom/mediatek/common/hdmi/IHDMINative;

    if-nez v8, :cond_1

    .line 1172
    const-class v8, Lcom/mediatek/common/hdmi/IHDMINative;
    ...
    check-cast v8, Lcom/mediatek/common/hdmi/IHDMINative;
    ...
    .line 1173
    .restart local v0       #callback:Landroid/os/MessageMonitorLogger$MessageLoggerCallbacks;
    :catch_0
    move-exception v1
    ...
    .end local v2           #filter:Landroid/content/IntentFilter;
    .end local v3           #intent:Landroid/content/Intent;
    .end local v4           #ipoEventFilter:Landroid/content/IntentFilter;
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSmartBookPlugIn:Z
    ...
    invoke-virtual {v12}, Landroid/bluetooth/BluetoothAdapter;->getState()I
    ...
    .line 2481
    invoke-virtual {v12}, Landroid/bluetooth/BluetoothAdapter;->enable()Z
    ...
    invoke-virtual {v3, v5}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->doKeyguardTimeout(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->dismiss()V
    ...
    invoke-interface {v3, v5}, Landroid/view/WindowManagerPolicy$WindowManagerFuncs;->switchInputMethod(Z)V
    ...
    invoke-interface {v3, v0}, Lcom/android/internal/statusbar/IStatusBarService;->dispatchStatusBarKeyEvent(Landroid/view/KeyEvent;)V
    :try_end_1
    ...
    const-string v5, "dispatchStatusBarKeyEvent error, "
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    const-string v23, "interceptKeyTq: result="
    ...
    const-string v23, " mVolumeDownKeyTriggered ="
    ...
    const-string v23, " mVolumeUpKeyTriggered ="
    ...
    .line 4435
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isGesturePowerOn()Z

    move-result v11

    .line 4436
    .local v11, isGestureOn:Z
    const-string v22, "persist.sys.isgesturepoweron"
    ...
    .line 4439
    .end local v11           #isGestureOn:Z
    :cond_9
    if-eqz v7, :cond_a

    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isGestureKeyCode(I)Z
    ...
    const-string v22, "gesture_switch"
    ...
    const-string v23, "interceptKeyBeforeDispatching: gesture switcher is "
    ...
    const-string v22, "send broadcast start"
    ...
    .line 4445
    .local v9, gestureIntent:Landroid/content/Intent;
    ...
    .line 4446
    const-string v21, "intent.action.gesture.UNLOCK.STARTAPP"
    ...
    const-string v22, "send broadcast successful"

    invoke-static/range {v21 .. v22}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 4454
    .end local v9           #gestureIntent:Landroid/content/Intent;
    ...
    .line 4411
    .local v16, monitorHandler:Landroid/os/Handler;
    if-eqz v16, :cond_8
    ...
    .line 4416
    const-string v21, "ScreenOnMonitor"

    const-string v22, "Now is screen off, send the screen on monitor message"
    ...
    .line 4436
    .end local v16           #monitorHandler:Landroid/os/Handler;
    .end local v17           #msg:Landroid/os/Message;
    .restart local v11       #isGestureOn:Z
    :cond_12
    const-string v21, "0"
    ...
    const-string v21, "persist.sys.anr_sys_key"
